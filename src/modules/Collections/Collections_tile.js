...
import Collection_Lower_homepage from "../../common/components/Collection_Lower_homepage";
          ...
          {CollectionTile_Api.map((curElem) => {
            ...
            return (
              <div className="col-md-6 col-lg-3 col-sm-12 mt-5">
                <div
                  className="card nft-card-radius collection-card border-radius pt-4"
                  style={{ marginLeft: "1em", backgroundColor: "#F8F8F8" }}
                >
                  <div className="text-center">
                    <img
                      className="img-fluid border-radius collection-img-card-radius"
                      src={image}
