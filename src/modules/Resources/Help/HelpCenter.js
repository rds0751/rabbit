            ...
            <div className="single-card">
              <div className="">
                <div className="">
                  ...
                  <div className="title-help">{data[0].title}</div>
                  <div style={{ width: "101.4%" }}>
                    <p title={data[0].description} className="content">{data[0].description.slice(0, 73) + "..."}</p>
            ...
            <div className="single-card">
              <div className="">
                <div className="">
                  ...
                  <div className="title-help">{data[1].title}</div>
                  <div style={{ width: "101.4%" }}>
            ...
            <div className="single-card">
              <div className="">
                <div className="">
                  ...
                  <div className="title-help">{data[2].title}</div>
                  <div style={{ width: "101.4%" }}>
                    <p title={data[2].description} className="content">{data[2].description.slice(0, 73) + "..."}</p>
            ...
            <div className="single-card">
              <div className="">
                <div className="">
                  ...
                  <div className="title-help">{data[3].title}</div>
                  <div style={{ width: "101.4%" }}>
                    <p title={data[3].description} className="content">{data[3].description.slice(0, 73) + "..."}</p>
