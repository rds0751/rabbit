      ...
      <div className="homepage">
                ...
                <Col lg={6}>
                  <div className="left-text">
                    <h1 className="heading">
                      {
                        loader ? <Skeleton width="250px" /> :
                          customize.appearance.heading ? customize.appearance.heading : 'Buy, Trade and Sell your NFTs'
                      }
                    </h1>
                    ...
                    <p className="text">
                      {
                        loader ? <Skeleton count="3" /> :
                          customize.appearance.description ? customize.appearance.description : 'One stop solution for all types of NFTs'
                      }
                    </p>
                    <div style={{ display: "flex" }}>
                      {
                        loader ? <Skeleton className="btn-loader" width="137px" height="44px" /> :
                          <Button
        ...
        <div className="create-sell-nft">
          <h2 className="heading">
            {
              loader ? <Skeleton width="40rem" height="40px" /> : 'Create and sell your NFTs'
            }
          </h2>
          <div className="inner-width">
            <div className="d-flex justify-content-center flex-wrap">
              <Card className="first-card-nft">
                ...
                {
                  loader ? <Skeleton width="89px" height="89px" /> :
                    <svg xmlns="http://www.w3.org/2000/svg" width="89" height="89" viewBox="0 0 89 89">
                      <g id="Wallet" transform="translate(-330 -1397)">
                        ...
                        <g id="Wallet-2" data-name="Wallet" transform="translate(333 1406)">
                          ...
                          <path id="Path_645" data-name="Path 645" d="M68.094,40.166,40.166,68.094a7.17,7.17,0,0,1-10.14,0L2.1,40.166a7.17,7.17,0,0,1,0-10.14L30.027,2.1a7.17,7.17,0,0,1,10.14,0L68.094,30.027a7.169,7.169,0,0,1,0,10.14" transform="translate(0 0)" fill={fetchPalletsColor(customize.appearance.colorPalette)} />
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="89" height="89" viewBox="0 0 89 89">
                      <g id="Collection" transform="translate(-721 -1397)">
                        ...
                        <g id="Group_624" data-name="Group 624" transform="translate(726 1407)">
                          <path id="Path_650" data-name="Path 650" d="M400.454,325.352a4.429,4.429,0,1,1-7.65-4.465l6.821-11.814c.007-.014.015-.026.022-.039a4.429,4.429,0,0,1,7.685,4.4h0l-6.878,11.912Zm-7.692-28.171q.022-.04.046-.079v0a4.429,4.429,0,0,1,7.671,4.429l-13.754,23.824a4.429,4.429,0,1,1-7.651-4.463Zm-13.727,0,.032-.055,0,0a4.429,4.429,0,0,1,7.67,4.429l-.007.014h0v0l-6.87,11.9a4.429,4.429,0,1,1-7.671-4.428l6.845-11.856Z" transform="translate(-328.475 -257.589)" fill={fetchPalletsColor(customize.appearance.colorPalette)} fill-rule="evenodd" />
                          <path id="Path_651" data-name="Path 651" d="M146.015,303.795a4.428,4.428,0,1,1-.046-8.856H159.7a4.428,4.428,0,1,1,0,8.857H146.015Z" transform="translate(-134.683 -257.595)" fill={fetchPalletsColor(customize.appearance.colorPalette)} fill-rule="evenodd" />
                          <path id="Path_652" data-name="Path 652" d="M146.015,445.8a4.429,4.429,0,1,0-.046,8.857H159.7a4.429,4.429,0,1,0,0-8.858H146.015Z" transform="translate(-134.683 -384.676)" fill={fetchPalletsColor(customize.appearance.colorPalette)} fill-rule="evenodd" />
                          <path id="Path_653" data-name="Path 653" d="M229.273,301.611a4.429,4.429,0,1,1,7.648-4.468l6.866,11.894a4.429,4.429,0,0,1-7.671,4.429l-6.845-11.855Z" transform="translate(-208.067 -257.592)" fill={fetchPalletsColor(customize.appearance.colorPalette)} fill-rule="evenodd" />
                          <path id="Path_654" data-name="Path 654" d="M106.281,372.619a4.429,4.429,0,1,0-7.694,4.39l6.866,11.893a4.429,4.429,0,0,0,7.672-4.428l-6.845-11.854Z" transform="translate(-97.996 -321.138)" fill={fetchPalletsColor(customize.appearance.colorPalette)} fill-rule="evenodd" />
                          <path id="Path_655" data-name="Path 655" d="M236.092,372.619a4.429,4.429,0,1,1,7.694,4.39L236.92,388.9a4.429,4.429,0,1,1-7.67-4.428l6.844-11.854Z" transform="translate(-208.063 -321.138)" fill={fetchPalletsColor(customize.appearance.colorPalette)} fill-rule="evenodd" />
                          <path id="Path_656" data-name="Path 656" d="M113.108,301.611a4.429,4.429,0,1,0-7.648-4.468l-6.868,11.894a4.429,4.429,0,1,0,7.672,4.428l6.844-11.855Z" transform="translate(-98 -257.592)" fill={fetchPalletsColor(customize.appearance.colorPalette)} fill-rule="evenodd" />
                          <path id="Path_657" data-name="Path 657" d="M278.941,215.513a4.429,4.429,0,1,1,6.05,1.621,4.431,4.431,0,0,1-6.05-1.621Z" transform="translate(-249.923 -185.092)" fill={fetchPalletsColor(customize.appearance.colorPalette)} fill-rule="evenodd" />
                          <path id="Path_658" data-name="Path 658" d="M373.717,60.214a4.429,4.429,0,1,1-6.05-1.621,4.431,4.431,0,0,1,6.05,1.621Z" transform="translate(-323.3 -57.999)" fill={fetchPalletsColor(customize.appearance.colorPalette)} fill-rule="evenodd" />
                          <path id="Path_659" data-name="Path 659" d="M235.391,135.644a4.429,4.429,0,1,1,1.622,6.05,4.432,4.432,0,0,1-1.622-6.05Z" transform="translate(-213.238 -121.541)" fill={fetchPalletsColor(customize.appearance.colorPalette)} fill-rule="evenodd" />
                          <path id="Path_660" data-name="Path 660" d="M417.267,140.074a4.429,4.429,0,1,1-1.622-6.05A4.432,4.432,0,0,1,417.267,140.074Z" transform="translate(-359.985 -121.542)" fill={fetchPalletsColor(customize.appearance.colorPalette)} fill-rule="evenodd" />
                          <path id="Path_661" data-name="Path 661" d="M287.2,62.429A4.429,4.429,0,1,1,282.775,58a4.429,4.429,0,0,1,4.429,4.429" transform="translate(-249.921 -58)" fill={fetchPalletsColor(customize.appearance.colorPalette)} fill-rule="evenodd" />
                          <path id="Path_662" data-name="Path 662" d="M374.3,213.287a4.429,4.429,0,1,1-4.429-4.429,4.429,4.429,0,0,1,4.429,4.429" transform="translate(-323.294 -185.081)" fill={fetchPalletsColor(customize.appearance.colorPalette)} fill-rule="evenodd" />
                          <path id="Path_663" data-name="Path 663" d="M322.491,140.074a4.429,4.429,0,1,1,6.05,1.622A4.432,4.432,0,0,1,322.491,140.074Z" transform="translate(-286.609 -121.542)" fill={fetchPalletsColor(customize.appearance.colorPalette)} fill-rule="evenodd" />
                        </g>
                      </g>
                    </svg>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="89" height="89" viewBox="0 0 89 89">
                      <g id="NFTs" transform="translate(-1111 -1397)">
                        ...
                        <g id="Group_625" data-name="Group 625" transform="translate(1114 1412)">
                          <path id="Path_664" data-name="Path 664" d="M128.515,137.043a2.571,2.571,0,0,0-4.566-.064l-17.091,31.885L95.214,150.818a2.551,2.551,0,0,0-4.285,0L70.522,182.7a2.58,2.58,0,0,0,2.143,3.941H149.19a2.621,2.621,0,0,0,2.283-3.75Z" transform="translate(-70.134 -126.7)" fill={fetchPalletsColor(customize.appearance.colorPalette)} />
                          <path id="Path_665" data-name="Path 665" d="M230.229,97.338a11.479,11.479,0,1,0-8.117-3.362A11.477,11.477,0,0,0,230.229,97.338Zm0-17.856a6.376,6.376,0,1,1-4.51,1.868A6.38,6.38,0,0,1,230.229,79.482Z" transform="translate(-197.087 -74.38)" fill={fetchPalletsColor(customize.appearance.colorPalette)} />
                        </g>
                      </g>
                    </svg>
                }
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="89" height="89" viewBox="0 0 89 89">
                      <g id="Sale" transform="translate(-1502 -1397)">
                        ...
                        <g id="Group_626" data-name="Group 626" transform="translate(1518 1413)">
                          <path id="noun-sale-3266461" d="M103.2-.06a1.77,1.77,0,0,0-1.282.525L70.55,31.83a1.768,1.768,0,0,0,0,2.493L92.232,56.014a1.769,1.769,0,0,0,2.5,0L126.09,24.649a1.769,1.769,0,0,0,.522-1.278l-.39-21.305A1.768,1.768,0,0,0,124.484.333Z" transform="translate(-70.036 0.06)" fill={fetchPalletsColor(customize.appearance.colorPalette)} />
        ...
        <div className="why-marketplace">
          <h2 className="heading-why">
            {
              loader ? <Skeleton width="40rem" height="40px" /> : 'Why this Marketplace'
            }
          ...
          <div className="inner-width">
            <div className="d-flex justify-content-md-center flex-wrap">
              ...
              <div className="d-flex align-items-center justify-content-left media card-home-page">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60">
                      <g id="Stats" transform="translate(-837 -2262)">
                        ...
                        <g id="Group_641" data-name="Group 641" transform="translate(-45 286)">
                          <rect id="Rectangle_994" data-name="Rectangle 994" width="10" height="43" rx="2" transform="translate(893 1985)" fill={fetchPalletsColor(customize.appearance.colorPalette)} />
                          <rect id="Rectangle_995" data-name="Rectangle 995" width="10" height="22" rx="2" transform="translate(907 2006)" fill={fetchPalletsColor(customize.appearance.colorPalette)} />
                          <rect id="Rectangle_996" data-name="Rectangle 996" width="10" height="26" rx="2" transform="translate(921 2002)" fill={fetchPalletsColor(customize.appearance.colorPalette)} />
                        </g>
                      </g>
                    </svg>
                }
                ...
                <p className="browse-text">
                  {
                    loader ? <Skeleton width={"250px"} /> : 'Stats to show pricing history'
                  }
                </p>
              </div>
              <div className="d-flex align-items-center justify-content-left media card-home-page">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60">
                      <g id="Easy" transform="translate(-955 -2262)">
                        ...
                        <g id="Group_642" data-name="Group 642" transform="translate(36.014 -40)">
                          <path id="Path_667" data-name="Path 667" d="M222.506,113.229a3.793,3.793,0,0,1-.117,5.374L209.3,131.089a3.854,3.854,0,0,1,5.4.2,3.429,3.429,0,0,1-.236,4.858l-1.781,1.682a3.843,3.843,0,0,1,6,1.048,4.064,4.064,0,0,1-.921,4.834l-1.943,1.835a3.856,3.856,0,0,1,5.233.025l0,0a3.665,3.665,0,0,1,.024,5.392l-7.309,6.9a13.862,13.862,0,0,1-18.812-.075l-5.93-5.6a12.09,12.09,0,0,1-2.543-14.534,15.357,15.357,0,0,0,1.7-10.664,3.612,3.612,0,0,1,1.087-3.337,4.116,4.116,0,0,1,6.749,1.871l1.148,6.627,1.335-1.261,18.642-17.782a3.794,3.794,0,0,1,5.353.116Z" transform="translate(744.891 2200.202)" fill={fetchPalletsColor(customize.appearance.colorPalette)} />
                          <path id="Path_668" data-name="Path 668" d="M297.89,34.319l.071-10.262,3.7.026-.071,10.262Z" transform="translate(645.253 2277.943)" fill={fetchPalletsColor(customize.appearance.colorPalette)} />
                          <path id="Path_669" data-name="Path 669" d="M346.44,67.308l6.62-6.612,2.614,2.617-6.62,6.612Z" transform="translate(602.366 2245.578)" fill={fetchPalletsColor(customize.appearance.colorPalette)} />
                          <path id="Path_670" data-name="Path 670" d="M202.11,65.623,204.718,63l6.533,6.5-2.608,2.623Z" transform="translate(729.86 2243.543)" fill={fetchPalletsColor(customize.appearance.colorPalette)} />
                        </g>
                      </g>
                    </svg>
                }
                ...
                <p className="browse-text">
                  {
                    loader ? <Skeleton width={"250px"} /> : 'Easy to sell and buy NFT'
                  }
                </p>
              </div>
              <div className="d-flex align-items-center justify-content-left media card-home-page">
                ...
                <p className="browse-text">
                  {
                    loader ? <Skeleton width={"250px"} /> : 'Make offers on NFTs'
                  }
                </p>
              </div>
              <div className="d-flex align-items-center justify-content-left media card-home-page">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60">
                      <g id="Activity" transform="translate(-816 -2368)">
                        ...
                        <g id="Group_652" data-name="Group 652" transform="translate(-69 4)">
                          <g id="Rectangle_1006" data-name="Rectangle 1006" transform="translate(896 2373)" fill="#fff" stroke={fetchPalletsColor(customize.appearance.colorPalette)} stroke-width="2" stroke-dasharray="3 2">
                            <rect width="38" height="38" rx="2" stroke="none" />
                            <rect x="1" y="1" width="36" height="36" rx="1" fill="none" />
                          </g>
                          <rect id="Rectangle_1003" data-name="Rectangle 1003" width="15" height="15" rx="2" transform="translate(890 2371)" fill={fetchPalletsColor(customize.appearance.colorPalette)} />
                          <rect id="Rectangle_1004" data-name="Rectangle 1004" width="15" height="15" rx="2" transform="translate(924 2371)" fill={fetchPalletsColor(customize.appearance.colorPalette)} />
                          <rect id="Rectangle_1005" data-name="Rectangle 1005" width="15" height="15" rx="2" transform="translate(908 2402)" fill={fetchPalletsColor(customize.appearance.colorPalette)} />
                        </g>
                      </g>
                    </svg>
                }
                ...
                <p className="browse-text">
                  {
                    loader ? <Skeleton width={"250px"} /> : 'See all the activities on NFT'
                  }
                </p>
              </div>
                  ...
                  loader ? <Skeleton className="margin-svg" width={"60px"} height={'60px'} /> :
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 60 60">
                      <g id="Blockchain" transform="translate(-1302 -2368)">
                        <rect id="Rectangle_997" data-name="Rectangle 997" width="60" height="60" transform="translate(1302 2368)" fill="transparent" />
